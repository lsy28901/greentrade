    ...
    <div class="row">
        <section class="col-md-12">
            ...
            <div class="border rounded" style="min-height: 400px; min-width: 600px; position: relative;">
                ...
                <c:set var="imageFileName" value="${reportContent.reportimgurl}" />
                <c:set var="imagePath" value="${pageContext.request.contextPath}/uploads/${reportContent.reportimgurl}" />
                
                <c:if test="${not empty reportContent.reportimgurl}">
                    <img src="${imagePath}"
                        style="max-width: 40%; height: auto;"
                        class="border rounded position-absolute bottom-0 end-0 p-2">
                </c:if>
            </div>
