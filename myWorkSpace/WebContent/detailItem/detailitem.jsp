...
<body>
	<main>
			...
			<div id="Product_info2_container">
				...
				<div id="info2_detail">
					<div id="info2_detail2">
						...
						<div>
							<span style="font-weight:bold;">상품상태</span><br>
				...
				<div id="button_Container">
					<button id="chatBtn"><a href="/myWorkSpace/chat.do?productno=${prodetail.productno}">채팅하기</a></button> 
		...
		<div id="seller_container">
			<div id="Product_ment">
				<div>상품설명</div>
				<div id="prodetailBox">${prodetail.productDetail}</div>
			</div>
			...
			<div id="Seller_info">
				...
				<div id="info_box">
					<div id="info_detail1">
						...
						<div><img style="width:100px; height:100px;" src="${sellerInfo.imgurl}"></div>
					</div>
					<div>
						<p>그린스코어</p>
						<p>${sellerInfo.greenscore}</p>
					</div>
				<a id="moreinfo" href="/myWorkSpace/sellinfo.do?userno=${sellerInfo.userno}">${sellerInfo.nickname}님의 정보 더보기</a>
				</div>
			</div>
		</div>
		<hr>
