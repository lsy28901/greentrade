...
public class DeleteLogsController implements Action{

	@Override
	public ActionForward execute(HttpServletRequest req, HttpServletResponse resp) {
		System.out.println("DeleteLogs액션컨트롤러");
		...
		buyLogService.deleteLogs(productno);
		
		
		forward.setRedirect(true);
		forward.setPath("/myWorkSpace/insertbuyList.do?productno=" + productno);
		return forward;
	}
